...
#==================
leave_yrs<- 11
covariates<-c("lag2_NPGO","lag1_log_SAR2","lag2_log_smolts","zl_flow", "lag1_PDO","lag1_NPGO","lag2_PDO","pink_ind","lag1_log_SAR1")
...
results<-inseason_forecast(series$series,
                  leave_yrs=leave_yrs,
                  covariates= c("lag2_NPGO","lag1_log_SAR2","lag2_log_smolts","zl_flow"), #use to automate variable selection: best_covariates[[1]][[best_covariates[[2]]$model_num[1]]],
