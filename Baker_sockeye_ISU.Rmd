...
#==================
leave_yrs<- 11
covariates<-c("lag2_NPGO")#"zl_flow",,"lag1_log_SAR2","lag1_log_SAR1","lag2_PDO","lag1_NPGO","pink_ind","pink_ind","lag2_NPGO",
plot_results = F
...
dat<-read_csv(here("data","tbl_totalSockeyeCountByArea.csv"))%>%
  ...
  filter(date <= as.Date("2021-07-09"))
...
#   mutate(zl_flow = ifelse(period==1,zl_flow,0))
