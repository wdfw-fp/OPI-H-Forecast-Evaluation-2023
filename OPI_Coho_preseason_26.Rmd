...
sstdat<-get_ersst_v5_new(years=c(min(Yrlist$year):max(Yrlist$year)),
                           ...
                           ncfilename="sst.mnmean_2_3_2026.nc",
                           latrange=c(44,50),
                           lonrange=c(-125,-120)
)%>%
  filter(!is.na(sst))%>%
...
if(!file.exists("results/forecasts_2-3-26_2.rds")|redo_forecasts==TRUE){
  results2<-SalmonForecasting::one_step_ahead(
    series=dat,
                  leave_yrs=leave_yrs,
                  TY_ensemble=TY_ensemble,
...
save(results,file="results/forecasts_2-3-26_2.rds")
}else{
  load("results/forecasts_2-3-26_2.rds")
}
