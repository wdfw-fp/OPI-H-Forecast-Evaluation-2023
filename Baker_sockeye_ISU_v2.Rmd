...
ISU_pct_error <- mean(abs((results_best$error/results$abundance)*100),na.rm = T) 
ISU_msa <- 100*(exp(median(abs(log(results_best$predicted_abundance/results$abundance)),na.rm = T))-1)
