---
title: Columbia Sockeye Inseason Forecast for Counts 5/15-9/30 @ Bonneville Dam
...
#===========================
date_start_analysis<-ymd("2002/5/15") #this will be the first date of data used in the analysis (and this month/day first in years thereafter)
date_end_analysis<-ymd("2022/9/30") #this will be the last date of data used in the analysis (and this month/day last in years preceding)
...
forecast_period_start_d<-15 #this will be the month day associated with the first month/day of the seasonal estimate period each year...can be after first data used to estimate it or the same
...
#==================
leave_yrs<- 11
covariates<-c("pink_ind","lag2_NPGO","lag1_log_SAR1","lag1_log_SAR2") #"lag1_NPGO","lag1_PDO","lag2_PDO",
plot_results = F
