...
#===========================
date_start_analysis<-ymd("2003/1/1") #this will be the first date of data used in the analysis (and this month/day first in years thereafter)
...
covariates<-c("lag1_PDO","lag2_PDO","lag1_log_jCK","lag2_PC1")
#==================
#forecasting params
#==================
leave_yrs<- 12
